...
vendorAccountSchema.virtual("isLocked").get(function() {
  return !!(this.lockUntil && this.lockUntil > Date.now());
});

vendorAccountSchema.pre("save", function() {
...
vendorAccountSchema.pre("save", async function() {
...
vendorAccountSchema.methods.comparePassword = async function(enteredPassword) {
  return await bcrypt.compare(enteredPassword, this.password);
};

vendorAccountSchema.methods.incLoginAttempts = function() {
...
vendorAccountSchema.methods.resetLoginAttempts = function() {
  return this.updateOne({
