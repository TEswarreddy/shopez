...
adminAccountSchema.pre("save", async function() {
...
adminAccountSchema.methods.comparePassword = async function(enteredPassword) {
  return await bcrypt.compare(enteredPassword, this.password);
};

adminAccountSchema.methods.incLoginAttempts = function() {
...
adminAccountSchema.methods.resetLoginAttempts = function() {
  return this.updateOne({
...
adminAccountSchema.methods.updateActivity = function() {
  this.lastActivity = new Date();
  return this.save();
};

adminAccountSchema.methods.recordLogin = function() {
  this.lastLogin = new Date();
  this.loginCount += 1;
  return this.save();
};

adminAccountSchema.methods.hasPermission = function(permission) {
